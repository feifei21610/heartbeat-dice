...
两个人的联机小游戏。轮流摇骰子，点数小的那个人认罚 ——
**赢的人从四道随机题里挑一道，输的人老实回答。**

**在这里玩** → https://feifei21610.github.io/heartbeat-dice/

## 怎么玩

1. 一个人点「我来开一局」，选打几轮，拿到一个 4 位房号
2. 把房号告诉另一个人，对方点「我有房号，加入她」输进去
3. 房主点开始，然后各摇各的
4. 每轮两颗骰子加起来，小的人认罚：**赢的人从四道题里挑一道**给对方
5. 两个人都看得到这四道题，但只有赢的人能挑；两人点数一样就重摇
6. 打满设定的轮数，赢的轮数多的人获胜
...
```bash
npm test    # 78 条：引擎单测 + 服务端房间集成测试
npm run e2e # 12 条：双人对战 / 赢家挑题 / 刷新重连 / 断网重连
